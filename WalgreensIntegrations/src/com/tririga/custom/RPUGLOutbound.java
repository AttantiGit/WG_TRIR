...
public class RPUGLOutbound implements CustomBusinessConnectTask{
	...
	public boolean execute(TririgaWS tws, long userId, Record[] records) {
        ...
        try{
    		String integration = "RPU GL Outbound";
    		...
    		try{
				...
				new RPUGLOutboundProcess().process(tws, writer, invoiceHeaderRecordData, pmtLnItemsItemrecordData);
    		}catch(Exception e ){
