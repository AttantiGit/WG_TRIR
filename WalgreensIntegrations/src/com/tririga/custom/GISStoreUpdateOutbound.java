...
public class GISStoreUpdateOutbound implements CustomBusinessConnectTask{
	...
	public boolean execute(TririgaWS tws, long userId, Record[] records) {
        ...
        try{
    		String integration = "GIS Store Update Outbound";
    		...
    		try{
				...
				new GISStoreUpdateOutboundProcess().process(tws, writer, invoiceHeaderRecordData, pmtLnItemsItemrecordData);
    		}catch(Exception e ){
