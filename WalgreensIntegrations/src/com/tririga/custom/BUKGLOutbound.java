...
public class BUKGLOutbound implements CustomBusinessConnectTask{
	...
	public boolean execute(TririgaWS tws, long userId, Record[] records) {
        ...
        try{
    		String integration = "BUK GL Outbound";
    		...
    		try{
				...
				new BUKGLOutboundProcess().process(tws, writer, invoiceHeaderRecordData, pmtLnItemsItemrecordData);
    		}catch(Exception e ){
