...
public class JobTitleInbound implements CustomBusinessConnectTask{
	...
	public boolean execute(TririgaWS tws, long userId, Record[] records) {
        ...
        try{
    		String integration = "HRIS Title Inbound";
    		...
    		try{
    			...
    			for(int i=0;i<configRecordData.length();i++ ){
    				...
    				if(IntegrationName.equalsIgnoreCase(integration)){
    					...
    					List<IntegrationField[]> data = new JobTitleInboundProcess().process(br);
