...
public class PaymentREInvoiceOutbound implements CustomBusinessConnectTask{
	...
	public boolean execute(TririgaWS tws, long userId, Record[] records) {
        ...
        try{
    		String integration = "Payment REInvoice Outbound";
    		...
    		try{
			    ...
			    //////Header query
			    ResultParsing invoiceResultParsing = new ResultParsing(queryTrigger.triggerQuery(param.getJsonQuery("triPayment", "triREInvoice", "cst - REInvoice - Header - Integration")));
				...
				ResultParsing pmtLnItemsParsing = new ResultParsing(queryTrigger1.triggerQuery(param1.getJsonQuery("triPayment", "triREInvoice", "cst - RE Invoice – Detail - Integration - PLI")));
				...
				new PaymentREInvoiceOutboundProcess().process(tws, writer, invoiceHeaderRecordData, pmtLnItemsItemrecordData);
    		}catch(Exception e ){
